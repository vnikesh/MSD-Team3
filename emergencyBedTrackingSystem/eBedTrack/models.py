...
class Patient(models.Model):
    #patient_id = models.IntegerField(blank=True, null=True, primary_key=True)
...
class Nurse(models.Model):
    #nurse_id = models.IntegerField(blank=True, null=True, primary_key=True)
...
class Hospital(models.Model):
    #hospital_id = models.IntegerField(blank=True, null=True, primary_key=True)
...
class Administrator(models.Model):
    #admin_id = models.IntegerField(blank=True, null=True, primary_key=True)
