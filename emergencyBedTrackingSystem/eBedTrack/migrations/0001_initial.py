...
=======
# Generated by Django 1.11.2 on 2017-11-14 22:53
...
=======
                ...
                ('patient_tag', models.CharField(max_length=20, unique=True)),
                ('first_name', models.CharField(blank=True, max_length=50, null=True)),
                ('last_name', models.CharField(blank=True, max_length=50, null=True)),
                ('sex', models.CharField(choices=[('M', 'MALE'), ('F', 'FEMALE')], default='M', max_length=10)),
...
=======
                ('bed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bedOfAdmission', to='eBedTrack.Bed')),
>>>>>>> a90a7bf453d8408adbe72fec5cb2fc80be0504fa
