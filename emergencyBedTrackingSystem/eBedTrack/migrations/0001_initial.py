# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-13 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_type', models.CharField(choices=[('1', 'ICU/CC'), ('2', 'EU'), ('3', 'MED/SURG'), ('4', 'OB'), ('5', 'SICU'), ('6', 'Neg-Pres/Iso'), ('7', 'OR'), ('8', 'Peds'), ('9', 'PICU'), ('10', 'NICU'), ('11', 'Burn'), ('12', 'Mental-Health'), ('13', 'Other')], default='ICU ', max_length=10)),
                ('bed_id', models.CharField(default=0, max_length=20)),
